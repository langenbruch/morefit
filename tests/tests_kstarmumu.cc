...
int main()
{
  ...
  if (true)
      ...
      for (unsigned int i=0; i<nruns*nmodels; i++)
	{
      ...
      TCanvas* c1_ = new TCanvas("c1", "c1", 3*800, 3*600);
      c1_->Divide(3,3);
      ...
      hfldiff_onnx_msemodified->SetLineColor(kOrange);
      hfldiff_onnx_msemodified_grad->SetLineWidth(1.0);
      hfldiff_onnx_msemodified_grad->SetLineColor(kOrange);
      hfldiff_onnx_msemodified_grad->SetLineStyle(kDashed);
      hfldiff_onnx_bdt->SetLineWidth(1.0);
      hfldiff_onnx_bdt->SetLineColor(kMagenta);
      ...
      hs3diff_onnx_msemodified->SetLineColor(kOrange);
      hs3diff_onnx_msemodified_grad->SetLineWidth(1.0);
      hs3diff_onnx_msemodified_grad->SetLineColor(kOrange);
      hs3diff_onnx_msemodified_grad->SetLineStyle(kDashed);
      hs3diff_onnx_bdt->SetLineWidth(1.0);
      hs3diff_onnx_bdt->SetLineColor(kMagenta);
      ...
      hs4diff_onnx_msemodified->SetLineColor(kOrange);
      hs4diff_onnx_msemodified_grad->SetLineWidth(1.0);
      hs4diff_onnx_msemodified_grad->SetLineColor(kOrange);
      hs4diff_onnx_msemodified_grad->SetLineStyle(kDashed);
      hs4diff_onnx_bdt->SetLineWidth(1.0);
      hs4diff_onnx_bdt->SetLineColor(kMagenta);
      ...
      hs5diff_onnx_msemodified->SetLineColor(kOrange);
      hs5diff_onnx_msemodified_grad->SetLineWidth(1.0);
      hs5diff_onnx_msemodified_grad->SetLineColor(kOrange);
      hs5diff_onnx_msemodified_grad->SetLineStyle(kDashed);
      hs5diff_onnx_bdt->SetLineWidth(1.0);
      hs5diff_onnx_bdt->SetLineColor(kMagenta);
      ...
      hafbdiff_onnx_msemodified->SetLineColor(kOrange);
      hafbdiff_onnx_msemodified_grad->SetLineWidth(1.0);
      hafbdiff_onnx_msemodified_grad->SetLineColor(kOrange);
      hafbdiff_onnx_msemodified_grad->SetLineStyle(kDashed);
      hafbdiff_onnx_bdt->SetLineWidth(1.0);
      hafbdiff_onnx_bdt->SetLineColor(kMagenta);
      ...
      hs7diff_onnx_msemodified->SetLineColor(kOrange);
      hs7diff_onnx_msemodified_grad->SetLineWidth(1.0);
      hs7diff_onnx_msemodified_grad->SetLineColor(kOrange);
      hs7diff_onnx_msemodified_grad->SetLineStyle(kDashed);
      hs7diff_onnx_bdt->SetLineWidth(1.0);
      hs7diff_onnx_bdt->SetLineColor(kMagenta);
      ...
      hs8diff_onnx_msemodified->SetLineColor(kOrange);
      hs8diff_onnx_msemodified_grad->SetLineWidth(1.0);
      hs8diff_onnx_msemodified_grad->SetLineColor(kOrange);
      hs8diff_onnx_msemodified_grad->SetLineStyle(kDashed);
      hs8diff_onnx_bdt->SetLineWidth(1.0);
      hs8diff_onnx_bdt->SetLineColor(kMagenta);
      ...
      hs9diff_onnx_msemodified->SetLineColor(kOrange);
      hs9diff_onnx_msemodified_grad->SetLineWidth(1.0);
      hs9diff_onnx_msemodified_grad->SetLineColor(kOrange);
      hs9diff_onnx_msemodified_grad->SetLineStyle(kDashed);
      hs9diff_onnx_bdt->SetLineWidth(1.0);
      hs9diff_onnx_bdt->SetLineColor(kMagenta);
